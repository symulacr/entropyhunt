...
export const HTML_V2_CSS_VARS = {
  ...
  backgroundSuccess: "#0b2a1b",
  backgroundInfo: "#0f1b33",
  backgroundWarning: "#2b1f0d",
  backgroundDanger: "#3b0d14",
  borderStrong: "#52525b",
  borderSecondary: "#3f3f46",
  borderTertiary: "#27272a",
  ...
  shellPanel: "#111118",
  heatmapHigh: "#1c1c24",
  heatmapMedium: "#52525b",
  heatmapLegendLow: "#a1a1aa",
  pulseSuccess: "#34d399",
  backgroundFocus: "#1a1a24",
  textActive: "#00d4aa",
  borderActive: "#00d4aa",
  textLight: "#e4e4e7",
  backgroundHighlight: "#00d4aa",
  backgroundMutedBlue: "#13131f",
  backgroundSuccessDim: "#0b2a1b",
  backgroundWarningDim: "#2b1f0d",
  backgroundDangerDim: "#3b0d14",
  backgroundNeutral: "#111118",
} as const;
...
export const COLORS = {
  ...
  accent: HTML_V2_CSS_VARS.textActive,
  ...
  bgSuccessDim: HTML_V2_CSS_VARS.backgroundSuccessDim,
  bgWarningDim: HTML_V2_CSS_VARS.backgroundWarningDim,
  bgDangerDim: HTML_V2_CSS_VARS.backgroundDangerDim,
  bgMutedBlue: HTML_V2_CSS_VARS.backgroundMutedBlue,
  bgNeutral: HTML_V2_CSS_VARS.backgroundNeutral,
  bgHighlight: HTML_V2_CSS_VARS.backgroundHighlight,
} as const;
